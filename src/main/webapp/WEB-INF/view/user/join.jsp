...
<div class="container">
    <div class="input-form-backgroud row">
        <div class="input-form col-md-12 mx-auto">
            ...
            <form class="validation-form" action="${path }/user/insert.do" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="name"  name="name" placeholder="아이디" required>
                    <div class="invalid-feedback">
                        이메일을 입력해주세요.
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="passwd" name="passwd" placeholder="비밀번호 (문자, 숫자, 특수문자 포함 8~20자)" required>
                    <div class="invalid-feedback">
                        이메일을 입력해주세요.
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="passwd2" name="passwd2" placeholder="비밀번호 재확인" required>
                    <div class="invalid-feedback">
                        이메일을 입력해주세요.
                    </div>
                </div>
